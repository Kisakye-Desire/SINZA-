...
export default function Home() {
  return <SiteShell><main>
    <section className="hero hero-fullbleed home-hero"><div className="hero-image"><img src="/images/wildlife-chimp-rainforest.jpg" alt="Chimpanzees in the rainforest of Uganda" /><span className="image-caption">Into the green</span></div><div className="hero-copy"><p className="eyebrow">Sinza Safaris · Since 2015</p><h1>Travel with<br /><em>purpose.</em></h1><p className="hero-lede">Tailor-made, purpose-driven safaris across Uganda and East Africa — connecting you with nature, culture and community.</p><div className="button-row"><Link href="/contact" className="button light">Start your journey <ArrowRight size={17} /></Link><Link href="#escape" className="hero-text-link">Scroll to explore <MoveUpRight size={15} /></Link></div></div><div className="scroll-cue">Scroll to discover <span /></div></section>

    <section id="escape" className="escape-section"><div className="escape-copy"><p className="eyebrow">Your East African escape</p><h2>Travel slowly.<br /><em>Look closely.</em></h2><div className="rule" /><p>From the quiet green of Bwindi to the wide skies of the savannah, we create journeys that feel personal from the first conversation to the final sundowner.</p><p>A gorilla encounter in <Link href="/destinations/bwindi">Uganda</Link>. A chimpanzee trail in <Link href="/destinations/kibale">Kibale</Link>. The Nile, the crater lakes, and the people who make every place feel alive.</p><Link href="/about" className="text-link">Why Sinza <ArrowRight size={15} /></Link></div><div className="escape-image"><img src="/images/wildlife-sunset-acacia.jpg" alt="African sunset with acacia trees" /><span>Not a template. Not a brochure. Just you and Africa as it really is.</span></div></section>
