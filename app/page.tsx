...
export default function Home() {
  return <SiteShell><main>
    <section className="hero hero-fullbleed home-hero"><HeroCarousel /><div className="hero-copy"><p className="eyebrow">Sinza Safaris · East Africa</p><h1>Wild places,<br /><em>deeply felt.</em></h1><p className="hero-lede">Private journeys through Uganda and East Africa, shaped around your pace, your people and the moments you came to find.</p><div className="button-row"><Link href="/contact" className="button light">Start your journey <ArrowRight size={17} /></Link><Link href="#escape" className="hero-text-link">Scroll to explore <MoveUpRight size={15} /></Link></div></div><div className="scroll-cue">Scroll to discover <span /></div></section>
