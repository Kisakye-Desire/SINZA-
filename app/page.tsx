...
export default function Home() {
  return <SiteShell><main>
    <section className="hero hero-fullbleed home-hero"><div className="hero-image"><img src="/images/primates/chimp-forest-portrait.jpg" alt="Chimpanzees in the rainforest of Uganda" /><span className="image-caption">Into the green</span></div><div className="hero-copy"><p className="eyebrow">Sinza Safaris · Since 2015</p><h1>Travel with<br /><em>purpose.</em></h1><p className="hero-lede">Tailor-made, purpose-driven safaris across Uganda and East Africa — connecting you with nature, culture and community.</p><div className="button-row"><Link href="/contact" className="button light">Start your journey <ArrowRight size={17} /></Link><Link href="/safari-intel" className="hero-text-link">Read the field notes <MoveUpRight size={15} /></Link></div></div><div className="scroll-cue">Scroll to discover <span /></div></section>
