...
export const safaris: Safari[] = [
  ...
  { slug: 'chimpanzees-queen-elizabeth', title: '4 Days Chimpanzees and Queen Elizabeth', duration: '4 days / 3 nights', category: 'Primates & Wildlife', summary: 'A compact chimpanzee and wildlife adventure through Kibale and Queen Elizabeth National Parks, beginning with a guided departure for Kibale National Park.', image: 'https://images.unsplash.com/photo-1549366021-9f761d450615?auto=format&fit=crop&w=1400&q=85', destinations: ['Kibale', 'Queen Elizabeth'], highlights: ['Chimpanzee experience', 'Kibale National Park', 'Queen Elizabeth wildlife', 'Three nights in Uganda’s west'] },
...
export const journeyCountries = [
  {
    ...
    journeys: [
      ...
      { slug: 'chimpanzees-queen-elizabeth', title: 'Chimpanzees and Queen Elizabeth', duration: '4 days / 3 nights', image: 'https://images.unsplash.com/photo-1549366021-9f761d450615?auto=format&fit=crop&w=1200&q=85' },
